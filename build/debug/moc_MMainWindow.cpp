...
QT_MOC_LITERAL(4, 34, 13), // "saveAnimation"
QT_MOC_LITERAL(5, 48, 14), // "selectMaterial"
QT_MOC_LITERAL(6, 63, 5), // "index"
QT_MOC_LITERAL(7, 69, 14), // "chooseMaterial"
QT_MOC_LITERAL(8, 84, 15) // "chooseCollision"

    },
    "MMainWindow\0openNewFile\0\0saveFile\0"
    "saveAnimation\0selectMaterial\0index\0"
    "chooseMaterial\0chooseCollision"
};
...
void MMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->saveAnimation(); break;
        case 3: _t->selectMaterial((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        case 4: _t->chooseMaterial(); break;
        case 5: _t->chooseCollision(); break;
        default: ;
        }
    }
}
